...
function materialWaste(totalMaterial, materialUnits, numJobs, jobConsumption) {
    let totalMaterialConsumed = jobConsumption*numJobs
    let remainingMaterial = totalMaterial - totalMaterialConsumed
    let x = remainingMaterial + materialUnits
    return x 
}
...
function interest(principal, rate, periods) {
    ...
    let finalInvestment = principal + sampleInterest
    return Math.floor (finalInvestment)
}
